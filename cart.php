                            ...
                            <table class="table table-responsive">
                                ...
                                <tbody>
                                    ...
                                    if ($ok == 2) {
                                        ...
                                        $str = implode(",", $item);
                                        $conn = mysqli_connect("localhost", "root", "", "diengiadung") or die("Can not connect database");
                                        ...
                                        while ($row = mysqli_fetch_assoc($query)) {
                                            ...
                                            <td class="cart_product_img">
                                                <a href="#"><img src="images/' . $row['img'] . '" alt="" width="200px" height="100px"></a>
                                            </td>
                                            <td class="cart_product_desc">
                                                <h5>' . $row['tenhang'] . '</h5>
                                            </td>
                                            <td class="price">
                                                <span>' . $row['giaban'] .'VND'. '</span>
                                            </td>
                                            <td class="qty">
                                            </td>
                                            <td>
                                            ...
                                            $total += $_SESSION['cart'][$row['id']] * $row['giaban'];
                                        }
                                        echo "<div class='pro' align='right'>";
                                        echo "<b>Tổng tiền cho các món hàng: <font color='red'>" .
                                            number_format($total, 3) . " VND</font></b>";
                                        echo "</div>";
                                        echo "<input type='submit' name='submit' value='Cập nhập giỏ hàng'>";
                                        echo "</form>";
                                        echo "<div class='pro' align='center'>";
                                        echo "<b><a href='shop.php'>Mua tiếp</a> - <a href='delcart.php?productid=0'>Xóa bỏ giỏ hàng</a></b>";
                                        echo "</div>";

                                    } 
                                    else {
                                        echo "<div class='pro'>";
                                        echo "<p align='center'>Bạn không có món hàng nào trong giỏ hàng<br /><a href='shop.php'>Mua</a></p>";
                                        echo "</div>";
                                    }
                                    ?>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="cart-summary">
                            ...
                            <ul class="summary-table">
                                ...
                                <li><span>phí chuyển:</span> <span>Miễn phí</span></li>
                                <li><span>tổng:</span> <span>$140.00</span></li>
                            </ul>
                            <div class="cart-btn mt-100">
                                <a href="checkout.php" class="btn amado-btn w-100">MUA HÀNG</a>
                            </div>
                        </div>
                    </div>
                </div>
